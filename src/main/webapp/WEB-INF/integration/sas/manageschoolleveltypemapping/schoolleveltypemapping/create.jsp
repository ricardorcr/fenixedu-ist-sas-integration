...
<div class="page-header">
	<h1><spring:message code="label.manageSchoolLevelTypeMapping.createSchoolLevelTypeMapping" />
		<small></small>
	</h1>
</div>
...
$(document).ready(function() {
    ...
    $("#schoolLevelTypeMapping_degreeType").select2().select2('val', '<c:out value='${param.degreetype}'/>');
